...
$_documentContainer.innerHTML = `<style data-fs-modal-dialog="">
/*
...
// var doc = (document._currentScript || document.currentScript).ownerDocument; // eslint-disable-line
var doc = $_documentContainer.content;
...
/**
    ...
    */
class FSModalDialog extends FSDialogBase {
  // only used for docs.
