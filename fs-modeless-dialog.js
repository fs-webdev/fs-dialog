import './fs-dialog-base.js';
const fsModelessDialogStyles = document.createElement('template');
fsModelessDialogStyles.setAttribute('style', 'display: none;');
fsModelessDialogStyles.innerHTML = `
...
class FSModelessDialog extends FS.dialog.baseDialogComponent {
  ...
  attachedCallback () {
    ...
    this.appendStyles(fsModelessDialogStyles, 'style[data-fs-modeless-dialog]', this);
